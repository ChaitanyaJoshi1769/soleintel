...
soleintel is an enterprise-grade platform designed for production deployment and scalable operations.

**Status:** Production-Ready | Enterprise-Grade | Open Source

## Overview

This repository contains a production-ready implementation of soleintel, built with modern technologies and best practices for enterprise scale.
...
helm install soleintel ./helm/chart -f values-staging.yaml
```
...
kubectl apply -f k8s/
helm install soleintel ./helm/chart -f values-prod.yaml
```
...
- **Issues**: [GitHub Issues](https://github.com/ChaitanyaJoshi1769/soleintel/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ChaitanyaJoshi1769/soleintel/discussions)
- **Community**: [Discord](https://discord.gg/cineflow)
- **Email**: support@soleintel.io
